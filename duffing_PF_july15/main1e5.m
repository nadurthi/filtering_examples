...
%--------------------------------------------------------------------------
    ...
    % PF - time update
    [X_pf Momx1 Momx2 Momp1 Momp2] = PF_time_update(X_pf, model, time, k, measTs,Nm);
    keyboard
